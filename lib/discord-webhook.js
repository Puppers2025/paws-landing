 ...
 * Lightweight Discord integration using webhooks and Discord bot for native notification badges
 */
  ...
  async postLevelUpNotification(user, levelUpData) {
    try {
      ...
      if (!this.botConnected) {
        ...
        if (!this.botConnected) {
          console.warn('Discord bot not connected, falling back to webhook');
