...
export default function ShopModal({ isOpen, onClose }) {
  ...
  const content = {
    daily: [
      { name: 'Daily Chest', cost: '100 $PAWS', desc: 'Open for daily loot' },
      { name: 'Energy Refill', cost: '50 $PAWS', desc: 'Boost your energy instantly' },
    ],
    upgrades: [
      { name: 'Speed Boost', cost: '200 $PAWS', desc: 'Increase movement speed' },
      { name: 'Healing Pack', cost: '150 $PAWS', desc: 'Recover faster from missions' },
    ],
    rewards: [
      { name: 'Rare Badge', cost: '300 $PAWS', desc: 'Earn special achievement badge' },
      { name: 'Mystery Crate', cost: '500 $PAWS', desc: 'Random high-value item' },
    ],
  }
  ...
  return (
    ...
    >
      <div className="bg-zinc-900 border border-red-600 rounded-xl w-full max-w-xl p-6 relative shadow-2xl">
        ...
        {/* Header / Main Content */}
        <h2 className="text-2xl font-primary mb-4 text-center text-red-500">🛍️ Pupper Shop</h2>
        <p className="text-gray-300 text-sm mb-6 text-center">
          Spend $PAWS to enhance your journey. Tap a tab to browse available items.
        </p>
