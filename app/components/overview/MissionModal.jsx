...
export default function MissionModal({ isOpen, onClose }) {
  ...
  const content = {
    daily: [
      { name: 'Scout Mission', cost: '50 $PAWS', desc: 'Quick recon for small rewards' },
      { name: 'Fetch Quest', cost: '100 $PAWS', desc: 'Standard daily mission for XP' },
    ],
    upgrades: [
      { name: 'Mission Booster', cost: '200 $PAWS', desc: 'Increase reward multipliers' },
      { name: 'Extra Slot', cost: '150 $PAWS', desc: 'Run an additional mission per day' },
    ],
    rewards: [
      { name: 'Mission Medal', cost: '300 $PAWS', desc: 'Proof of elite field service' },
      { name: 'Supply Cache', cost: '500 $PAWS', desc: 'Bulk rewards from completed ops' },
    ],
  }
  ...
  return (
    ...
    >
      <div className="bg-zinc-900 border border-red-600 rounded-xl w-full max-w-xl p-6 relative shadow-2xl">
        ...
        {/* Header / Main Content */}
        <h2 className="text-2xl font-primary mb-4 text-center text-red-500">🎯 Mission Control</h2>
        <p className="text-gray-300 text-sm mb-6 text-center">
          Spend $PAWS to send your pup on missions, enhance outcomes, or collect elite rewards.
        </p>
